...
//   			yield www; // AMCLEAN add
        ...
        t = androidCategory.GetComponentInChildren(Text);
        t.text = "Android Events";
...
//        AddButton("prodgenie" + "\n" + "bnb" + "\n" + "intrinsic" + "\n" + "nue" + "\n" + "uboone", "prodgenie_bnb_intrinsic_nue_uboone.json");
        ...
        t = lessThan2MB.GetComponentInChildren(Text);
        t.text = "Small Events";
        ...
        t = between2and6MB.GetComponentInChildren(Text);
        t.text = "Medium Events";
        ...
        t = moreThan6MB.GetComponentInChildren(Text);
        t.text = "Large Events";
